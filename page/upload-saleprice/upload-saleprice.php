    ...
    if ($file['error'] === UPLOAD_ERR_OK) {
        ...
        if ($fileExtension === 'xlsx' || $fileExtension === 'xls') {
            ...
            if ($dropdownValueMismatch) {
                echo '<script>alert("ฐานข้อมูลไม่ถูกต้อง อัพเดทไม่สำเร็จ"); window.location.href="saleprice.php";</script>';
                exit;
            }
            ...
            if ($updateSuccess) {
                ...
                if (move_uploaded_file($fileTmpPath, $uploadFilePath)) {
                    ...
                    echo '<script>alert("อัพเดทสำเร็จ และบันทึกไปยัง: ' . $uploadFilePath . '"); window.location.href="saleprice.php";</script>';
                } else {
                    echo '<script>alert("Failed to move uploaded file."); window.location.href="saleprice.php";</script>';
                }
            } else {
                echo '<script>alert("ไม่พบข้อมูล อัพเดทไม่สำเร็จ"); window.location.href="saleprice.php";</script>';
            }
        } else {
