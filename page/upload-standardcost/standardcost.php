                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10"><i class="ti-upload"></i> Update Standardcost </h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"> Standardcost </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update Standardcost</h5>
                    </div>
                    <div class="card-body">
                        <form id="uploadForm" action="upload-standardcost.php" method="post" enctype="multipart/form-data">
